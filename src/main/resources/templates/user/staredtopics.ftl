...
<div id='main'>
    ...
    <div id="content">
        ...
        <#-- 该用户收藏的话题 -->
        <div class="panel">
            <div class="header">${u.username} 收藏的话题</div>
            <div class="inner padding">
                ...
                <div class="pagination" current_page=${page}>
                    <ul>
                        <#-- 跳到第一页 -->
                        <li><a href="/user/staredtopics/${u.username}?page=1">«</a></li>
                        <#list 1..pages as p>
                            <li><a href="/user/staredtopics/${u.username}?page=${p}">${p}</a></li>
                        </#list>
                        <#-- 跳到最后一页 -->
                        <li><a href="/user/staredtopics/${u.username}?page=${pages}">»</a></li>
                    </ul>
                </div>
            </div>
        </div>
