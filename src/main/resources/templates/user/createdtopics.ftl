...
<#--                       <span class="count_of_visits" title="点击数">-->
                ...
                <div class="pagination" current_page=${page}>
                    <ul>
                        <#-- 跳到第一页 -->
                        <li><a href="/user/createdtopics/${u.username}?page=1">«</a></li>
                        <#list 1..pages as p>
                            <li><a href="/user/createdtopics/${u.username}?page=${p}">${p}</a></li>
                        </#list>
                        <#-- 跳到最后一页 -->
                        <li><a href="/user/createdtopics/${u.username}?page=${pages}">»</a></li>
                    </ul>
                </div>
