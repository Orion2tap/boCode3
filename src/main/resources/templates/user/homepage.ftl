...
<div id='main'>
    ...
    <div id="content">
        ...
        <div class="panel">
            ...
            <div class="inner userinfo">
                <div class="user_big_avatar">
                    <img src="/avatar/${u.avatar}" class="user_avatar" title="${u.username}">
                </div>
                <a class="dark">${u.username}</a>

                <p class="col_fade">注册时间 ${u.registrationTime}</p>
            </div>
        </div>
        ...
        <div class="panel">
            ...
            <#-- topic 按创建时间逆序排列 -->
            <#list latestCreatedTopics as t>
                <div class="cell">
                   <a class="user_avatar pull-left" href="/user/homepage/${u.username}">
                       <img src="/avatar/${u.avatar}" title="${u.username}">
                   </a>
...
<#--                   </span>-->
                   ...
                   <a class="last_time pull-right" href="/topic/detail/${t.id}">
                       ...
                       <#-- 宏调用 -->
                       <span class="last_active_time"><@f.timeago time = t.createdTime/></span>
                   </a>
                ...
                <div class="cell more">
                    <a class="dark" href="/user/createdtopics/${u.username}">查看更多»</a>
                </div>
        </div>
        ...
        <div class="panel">
            ...
            <#-- topic 按更新时间逆序排列 -->
            <#list latestCommentedTopics?sort_by(['latestComment', 'updatedTime'])?reverse as t>
                <div class="cell">
...
<#--                   <span class="count_of_visits" title="点击数">-->
                    ...
                    <#-- 贴子参与时间 -->
                    <a class="last_time pull-right" href="/topic/detail/${t.id}">
                        <img class="user_small_avatar" id="id-cot-newAvatar" src="/avatar/${t.newReviewerAvatar!'default.jpg'}">
                        <#-- 宏调用 -->
                        <span class="last_active_time"><@f.timeago time = t.latestComment.updatedTime/></span>
<#--                        <span class="last_active_time">${cot.latestComment.updatedTime}</span>-->
                    </a>
                ...
                <div class="cell more">
                    <a class="dark" href="/user/commentedtopics/${u.username}">查看更多»</a>
                </div>
        </div>
        ...
        <div class="panel">
            <div class="header">
                <span class="col_fade">最近收藏的话题</span>
            </div>

            <#-- topic 按收藏时间逆序排列 -->
            <#list latestStaredTopics as t>
                <div class="cell">
                    <#-- 贴子参与时间 -->
                    <a class="last_time pull-right" href="/topic/detail/${t.id}">
                        <#-- 宏调用 -->
                        <span class="last_active_time"><@f.timeago time = t.staredTime/></span>
                    </a>
            ...
            <div class="cell more">
                <a class="dark" href="/user/staredtopics/${u.username}">查看更多»</a>
            </div>
        </div>
    </div>
</div>
